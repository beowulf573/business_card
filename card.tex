...
\usepackage{graphicx}
\usepackage{url}
\usepackage[osf,sf]{garamond} % 5es
\renewcommand{\rmdefault}{5gm}
...
&    \hspace*{\lstart}{\large\it \What}\vspace{0.05in}&  \\
%    \rule[-2ex]{0ex}{2ex}

%    \small%
&    \hspace*{\lstart}{\small\TEL} &  \\
&    \hspace*{\lstart}{\small\Email} &  \\
&    \hspace*{\lstart}{\small\WEB}\vspace{0.2in} &  \\
